/* This script is based on following source, and a few modification was made to customize for the raspi-splash by Ai Dow,  Nov 2013 */
//
...
// esLoadTGA()
//
//    Loads a 32-bit TGA file. This is probably the simplest TGA loader ever.
...
char* ESUTIL_API esLoadTGA ( char *fileName, int *width, int *height )
{
    ...
    *height = attributes[3] * 256 + attributes[2];
    ...
    bytesRead = fread(buffer,1,imagesize,f);
    printf("bytes read= %d\n",bytesRead);
